  ...
  return (
    <div className="home-container">
      ...
      <p className="home-text">
        We hope this website will be usefull to you. If you encounter any problem here or in game, feel free to contact <b>FattyBear</b> or any of our guild's members, we'd be happy to be of help ! Keep in mind that you can contact us on our discord at anytime, and you can also find alot of informations there.
      </p>
      ...
      <p className="home-text">
        Nous espérons que ce site vous sera utile. Si vous avez un problème ou des questions, n'hésitez pas à contacter <b>FattyBear</b> ou un membre de notre guilde. Nous serons heureux de pouvoir vous aider ! Sans oublier que vous pouvez nous contacter via notre discord, vous y trouverez aussi diverses informations.
      </p>
